...
namespace MagicOnnxAi.Helpers
{
    public class ChatTemplate
    {
        public static string ChatTemplateGemma9b2(IEnumerable<AiMessage> messages, bool addGenerationPrompt = true)
        {
            return ChatTemplateGemma9b2Full(messages, addGenerationPrompt);
        }

        public static string ChatTemplateGemma9b2Full(IEnumerable<AiMessage> messages, bool addGenerationPrompt = true, string bosToken = "<|startoftext|>")
        {
        ...
        public static string ChatTemplatePhiMini3(IEnumerable<AiMessage> messages, bool addGenerationPrompt = true)
        {
            return ChatTemplatePhiMini3Full(messages, addGenerationPrompt);
        }
        public static string ChatTemplatePhiMini3Full(IEnumerable<AiMessage> messages, bool addGenerationPrompt = true, string eosToken = "<|endoftext|>")
        {
            var sb = new StringBuilder();
        ...
        public static string ChatTemplateLlama31(
               IEnumerable<AiMessage> messages,
               bool addGenerationPrompt = true)
        {
            return ChatTemplateLlama31Full(messages, addGenerationPrompt);
        }

        public static string ChatTemplateLlama31Full(
       IEnumerable<AiMessage> messages,
       bool addGenerationPrompt = true,
       ...
       bool? toolsInUserMessage = null)
        {
            ...
            if (firstMessage != null && firstMessage.Role == "system")
            {
                systemMessage = firstMessage.Content.Trim();
                messages = messages.Skip(1); // Skip the first element directly on IEnumerable
            }
